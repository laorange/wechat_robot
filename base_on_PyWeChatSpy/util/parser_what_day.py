...
weekday = ''
tbs_what_day = ['今天', '明天', '后天', '大后天', '大大后天', '早上', '中午', '晚上', '傍晚', '今日', '第一天', '明日', '第二天', '两天后', '第三天', '两天后',
                '第三天', '三天后', '第四天', '四天后', '第五天', '周一', '周二', '周三', '周四', '周五', '周六', '周日', '周天', '本周一', '本周二', '本周三',
                '本周四', '本周五', '本周六', '本周日', '本周天', '下周一', '下周二', '下周三', '下周四', '下周五', '下周六', '下周日', '下周天', '下星期一',
                '下星期二',
                '下星期三', '下星期四', '下星期五', '下星期六', '下星期日', '下星期天', '周1', '周2', '周3', '周4', '周5', '周6', '周7']
